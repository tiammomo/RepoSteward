...
from .local_operations import LocalOperations, OperationError, revision
from .local_queue import ASSISTANCE_ACTIONS, digest, encoded, enqueue, plan_for
from .projects import ProjectError, canonical_digest, workspace_metadata
...
class AssistanceOperations:
    ...
    def start(self, kind: str, *, idempotency_key: str, **parameters) -> dict:
        ...
        if kind == "verification":
            ...
            from .local_queue import hex_id
