...
from reposteward.core.config import AppConfig, VerificationProfile
from reposteward.core.models import AgentResult
from reposteward.projects.registry import canonical_digest
from reposteward.storage.snapshots import snapshot_summary, verify_snapshot_copy
    ...
    def request(
        ...
        *,
        ...
        with os.fdopen(descriptor, "w") as lease:
            ...
            from reposteward.verification.execution import begin
